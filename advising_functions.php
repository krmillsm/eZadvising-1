...
require_once("pe.php");
require_once("obj/CourseDBList.php");
require_once("obj/RecordsDBList.php");
require_once("obj/RequirementsDBList.php");


function defaultListSetup($studentId) {
    $con = new PDO(DBCONNECTSTRING, DBUSER, DBPASSWORD);

    $sql = 'Select programId, catalogYear from student_programs where studentId=:id';
    ...
    $records = new RecordsDBList($con, $courses, $studentId);
    $requirements = new RequirementsDBList($con, $courses, $records, $program['programId'], $program['catalogYear']);
    return [$courses, $records, $requirements];
}
...
//UPDATED DONE USED
function getRequirementsForStudent($requireList)
{
    return json_encode($requireList->getRequirements());
