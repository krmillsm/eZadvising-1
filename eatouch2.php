 ...
 console.dir($(ui.draggable).data());
  ...
  if(sourceId.substr(0,1) == "w") //original move coming from the working side-insert
  {
   ...
   /*  $.ajax({
      		url: url; 
      		method: 'POST';
      		data: {courseId: courseId,semesterCode: semesterCode, year: year, reqId: reqId, proposedReqId: proposedReqId};
      		success: function(result){
